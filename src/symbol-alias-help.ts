import type { SymbolAlias } from "./symbol-aliases.js";
...
export function groupSymbolAliases(aliases: readonly SymbolAlias[]): Map<string, string[]> {
...
export function renderSymbolAliases(root: HTMLElement | null): void {
    if (!root) return;
