...
export class FSGui {
    ...
    private renderInferenceProofState(
    ...
    private resetInferenceProofUi() {
        ...
        const history = document.getElementById("fs-proof-history");
        if (state) clearProofState(state);
        ...
        if (proofError && assistant) assistant.appendChild(proofError);
        if (scriptError && scriptOutput) scriptOutput.appendChild(scriptError);
        this.renderInferenceProofRecommendations();
