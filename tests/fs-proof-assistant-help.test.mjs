...
for (const tactic of ["intro", "exact", "apply", "assumption", "constructor", "left", "right", "symm", "rfl", "rw", "nth_rw", "simp", "contradiction", "by_contra", "by_cases", "contrapose", "have", "obtain", "revert", "qed"]) {
