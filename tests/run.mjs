const tests = [
    ...
    "./proof-fullscreen.test.mjs",
    "./proof-completion.test.mjs",
    "./proof-completion-dom.test.mjs",
    "./proof-completion-scope.test.mjs",
    ...
    "./tt-assist-context.test.mjs",
    "./tt-assist-refine.test.mjs",
    "./tt-assist-generalizing.test.mjs",
    "./tt-assist-term-cases.test.mjs",
    "./tt-assist-qed-simplify.test.mjs",
    "./tt-assist-structured-script.test.mjs",
    "./tt-assist-structured-process.test.mjs",
    "./tt-assist-structured-gui.test.mjs",
    "./tt-assist-local-facts.test.mjs",
    "./tt-assist-obtain.test.mjs",
    "./tt-assist-nested-patterns.test.mjs",
    "./tt-assist-obtain-process.test.mjs",
    ...
    "./tt-issue-47-dependent-bool.test.mjs",
    "./tt-issue-47-universe-kernel.test.mjs",
    "./tt-issue-48-sum-motive-capture.test.mjs",
    "./tt-issues-47-48-process.test.mjs",
    ...
    "./tt-nbe-public-meta-boundary.test.mjs",
    ...
    "./tt-core-clone-detached.test.mjs",
    "./tt-nbe-kernel.test.mjs",
    "./tt-nbe-term-sharing.test.mjs",
    ...
    "./tt-higher-path-primitives.test.mjs",
    ...
    "./tt-symbol-aliases.test.mjs",
    "./tt-astparser-surface-strict.test.mjs",
    "./tt-save-surface-migration.test.mjs",
    "./tt-nbe-explicit-hole-elaboration.test.mjs",
    "./tt-nbe-source-meta-constraint.test.mjs",
    "./tt-nbe-sigma-eqv.test.mjs",
    "./tt-nbe-target-pair.test.mjs",
    ...
    "./tt-proof-goal-secondary.test.mjs",
    ...
    "./tt-issue-26-dependent-pair-qed.test.mjs",
    "./tt-issue-27-dependent-rw-qed.test.mjs",
    ...
    "./tt-user-definition-surface-sugar.test.mjs",
    ...
    "./tt-core-inductive-rule-safety.test.mjs",
    "./tt-sandbox.test.mjs",
    ...
    "./tt-core-hit-indexed-path2-refl.test.mjs",
    ...
    "./tt-sandbox-hit2-refl.test.mjs",
    "./tt-sandbox-hit3.test.mjs",
    "./tt-sandbox-hit3-composite.test.mjs",
    "./tt-sandbox-hit3-refl.test.mjs",
    "./tt-sandbox-hit3-path2-refl.test.mjs",
    "./tt-sandbox-hit-definitional-boundary.test.mjs",
    "./tt-creative-sorry.test.mjs",
    ...
    "./tt-sandbox-save-surface-migration.test.mjs",
